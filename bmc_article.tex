...
The main objective of the exploitation phase is to choose the best solution based on the Q value.
...
All tests in the experiment were conducted without the need of a tester, automating the process of executing and designing performance test scenarios.    
...
\item $H1_{1}$  : The HybridQ didn't found best solution than the other metaheuristic approaches.
\end{itemize}
\end{itemize}
...
\item $H2_{1}$  : The HybridQ algorithm consumed more requests than the other algorithms in the executed experiments.
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item $H3_{0}$ (A null hypothesis) : The Hybrid algorithm consumed more requests than the other algorithms in the experiments performed.
\item $H3_{1}$  : The HybridQ algorithm consumed more requests than the other algorithms in the executed experiments.
\end{itemize}
\end{itemize}
